(function(){
    ...
    */
    ...
    cleanCpfs.forEach(function (cpf){
    ...
    let months = 'Os meses de janeiro, junho e julho começam com a letra j.'
    console.log(months.match(/ju[nl]ho/g))
    ...
    let text3=`<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>`
    console.log(text3.replace(/<(\w+)>([^<]+)<\/\w+>/g,`<$1>O texto dentro da tag "$1" é "$2"<\/$1>\n` ))
})();